...
function Header() {
  ...
  return (
    <div className="w-screen z-10 fixed top-0 h-20 flex justify-between bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 shadow-md">
      <div className="flex">
        <h2 className="m-5 text-4xl font-black bg-clip-text text-transparent bg-gradient-to-l from-blue-400 via-red-600 to-pink-500">Uniquee</h2>
      </div>
